function ScormStudioXBlock(runtime, element) {
  ...
  $(element)
    ...
    .bind("click", function () {
      ...
      var scorm_s3_path = $(element).find("input[name=scorm_s3_path]").val();
      var has_score = $(element).find("select[name=has_score]").val();
      var enable_navigation_menu = $(element)
        .find("select[name=enable_navigation_menu]")
        .val();
      ...
      var navigation_menu_width = $(element)
        .find("input[name=navigation_menu_width]")
        .val();
